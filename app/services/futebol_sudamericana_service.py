...
class FutebolSudamericanaService:
            ...
            for record in data:
                conn.execute(f"""
                    INSERT INTO {table_name} (
                        id, Dia, Fecha, Ciudad, Pais, Estadio, Hora_Local, GMT, Hora_BRA, Equipo_A, Versos, Equipo_B, Grupo, Cable_1, Abierta_1
                    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """, (
                    ...
                    record["Grupo"], record["Cable_1"], record["Abierta_1"]
                ))
            conn.close()
        except Exception as e:
    ...
    def get_all_texts(self, table_name, team_name: str = None, similarity_threshold: int = 80) -> List[Dict[str, str]]:
        ...
        try:
            ...
            columns = [
                ...
                "Equipo_A", "Versos", "Equipo_B", "Grupo", "Cable_1", "Abierta_1"
            ]
